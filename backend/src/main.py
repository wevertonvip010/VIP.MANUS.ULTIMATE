...
def init_admin_user():
    try:
        ...
        admin_user = users_collection.find_one({"cpf": "00000000000"})
        if not admin_user:
            user_model = User()
            admin_data = {
                "cpf": "00000000000",
            ...
            admin_data["password"] = user_model.set_password("vip123456")
            
            users_collection.insert_one(admin_data)
            print("Usuário admin padrão criado: CPF 00000000000 / Senha: vip123456")
